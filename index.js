...
const token = "7765461627:AAHC_7cwMG0HOSiQjZhkWOekwVAZFz14tJY";
  ...
  bot.on("message", async (msg) => {
    ...
    if (text === "/start") {
      await bot.sendMessage(
        chatId,
        "Saonbek.as platformasida bor kurslarni sotib olishingiz mumkin",
        {
          reply_markup: {
            keyboard: [
              [
                {
                  ...
                  web_app: {
                    url: "https://telegram-web-bot-six.vercel.app/",
                  },
                },
              ],
            ],
